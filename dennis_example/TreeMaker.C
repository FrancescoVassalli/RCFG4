...
//std::cout<<"starting jet analysis"<<std::endl;
  /*{
	...
	std::cout<<"ending jet"<<std::endl;
  }
std::cout<<"more jets"<<std::endl;
  {
...
//having problems with these so turning them off now 
/*  TowerBackground* towerbackground1 = findNode::getClass<TowerBackground>(topNode,"TowerBackground_Sub1");
  ...
  for (int layer = 0; layer < 3; layer++) { 
    std::cout<<"enter first layer loop"<<layer<<std::endl;
	for (unsigned int n = 0; n < towerbackground1->get_UE( layer ).size(); n++) {
	std::cout<<"tower empty?"<<std::endl;
